...
participant needs Quartus or a board of their own. It lives here rather than in a lecture appendix
because nobody following the course has to execute it.
...
GHDL (see [L02 Appendix C](../lectures/L02/appendix/c_testbenches.md)).
...
1. Download Quartus Prime Lite from
   ...
   * That link is the Windows kit for one particular release. Any recent Lite release works, on
     either host OS; this course doesn't depend on a specific point version, so pick the edition
