# Appendix A - Flip-Flops and Registers
...
The rising-edge form as a circuit; swap which side is inverted for a falling edge, which is the
form A.9's active-low button needs:
