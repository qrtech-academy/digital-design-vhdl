...
pulse, that holding the button produces no further pulses, that a release produces none at all, and
...
See [Appendix C.4b](../../L02/appendix/c_testbenches.md#c4b-when-the-design-needs-more-than-one-file).
